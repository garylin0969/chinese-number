// 中文數字位數名稱
const twDigits = ['', '十', '百', '千', '萬', '十', '百', '千', '億', '十', '百', '千', '兆', '十', '百', '千'];
const cnDigits = ['', '十', '百', '千', '万', '十', '百', '千', '亿', '十', '百', '千', '兆', '十', '百', '千'];
// 將繁體的大寫數字映射到其對應的其他表示方式
const twUpperCaseMap = new Map([
    ['零', ['0', '０', '〇', '零']],
    ['壹', ['1', '１', '一', '壹']],
    ['貳', ['2', '２', '二', '貳', '贰']],
    ['參', ['3', '３', '三', '參', '叁']],
...
// 將.轉換為中文點
const pointChinses = (locales = 'zh-TW') => (locales === 'zh-TW' ? '點' : '点');
// 將數字字串轉換為大寫
const toUpperCase = (str, locales = 'zh-TW') => {
    // 定義大寫數字的映射
    const upperCaseMap = locales === 'zh-TW' ? twUpperCaseMap : cnUpperCaseMap;
    let result = '';
...
// 將數字轉換為中文
function toChinese(num, locales = 'zh-TW') {
...
//將數字轉成中文(含單位)
function toChineseWithUnits(num, locales = 'zh-TW') {
    // 定義中文數位的陣列
